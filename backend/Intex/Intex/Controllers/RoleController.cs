...
namespace Intex.Controllers
{
    ...
    public class RoleController : Controller
    {
        ...
        //{
        //    return Ok(User.IsInRole("Administrator") ? "You are admin ✅" : "You are NOT admin ❌");
        //}

        [HttpGet("CheckRoleByEmail/{userEmail}")]
        public async Task<IActionResult> CheckRoleByEmail(string userEmail)
        {
